//! Provider-related configuration structures.
//!
//! This module contains configuration for LLM providers, model routing,
//! embedding routing, and reliability settings.

use serde::{Deserialize, Serialize};
use schemars::JsonSchema;
use std::collections::HashMap;

// Re-export from llm_schema
pub use crate::config::schemas::llm_schema::{
    ModelProviderConfig,
    ModelRouteConfig,
    EmbeddingRouteConfig,
};

/// Reliability and fallback configuration for providers.
///
/// Controls retry behavior, fallback chains, and error recovery.
...
pub struct ReliabilityConfig {
    ...
    #[serde(default)]
    pub provider_model_aliases: HashMap<String, HashMap<String, String>>,
