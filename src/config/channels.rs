...
//!
//! This module contains all configuration structures for the various
//! communication channels supported by ZeroClaw.
...
///
/// This is a placeholder for the email config structure
/// which is defined in the email module itself.
#[derive(Debug, Clone, Serialize, Deserialize, JsonSchema)]
pub struct EmailConfig {
    /// Email configuration is handled by the email module
    #[serde(flatten)]
